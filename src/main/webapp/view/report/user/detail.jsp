...
<body>
	<div class="page">
		...
		<section class="title-row">
			...
			<div class="url-chip">/report/detail?report_id=1&amp;target_type=MEETUP</div>
		</section>

		<section class="card">
			<div class="card-head">
				<div class="card-title">
					<span class="step">4-1</span>내 신고 상세
				</div>
				<span class="info-pill">PENDING 상태일 때 수정/삭제 가능</span>
			</div>
			<div class="inner">
				<div class="detail-grid">
					...
					<div class="detail-row">
						...
						<div class="detail-value">
							<span class="badge">${dto.target_type}</span>
						</div>
					</div>
					<div class="detail-row">
					...
					<div class="detail-row">
						...
						<div class="detail-value">욕설/비방 (ABUSE)</div>
					</div>
					<div class="detail-row">
						<div class="detail-label">상세 내용</div>
						<div class="detail-value">모임 소개글에 부적절한 표현이 포함되어 있습니다.</div>
					</div>
					<div class="detail-row">
					...
					<div class="detail-row">
						...
						<div class="detail-value">2026-06-17</div>
					</div>
				</div>
			</div>
			<div class="actions">
				<a href="/report/mylist" class="btn btn-white">목록</a>
				<a href="/meetup/detail?meetup_id=1" class="btn btn-soft-blue">해당 글 보기</a>
				<a href="/report/update?report_id=1&amp;target_type=MEETUP"
					class="btn btn-blue">수정</a>
				<button type="button" class="btn btn-red"
					onclick="location.href='moit_delete_confirm_modal_unified.html'">삭제</button>
			</div>
		</section>
