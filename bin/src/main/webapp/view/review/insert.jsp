...
body {
	background: var(--bg); /* ⚠️ CSS 변수 공백 오타 수정 */
}
...
.card {
	...
	border-radius: 20px;
	padding: 35px;
	box-shadow: var(--shadow); /* ⚠️ CSS 변수 공백 오타 수정 */
}
...
.meeting-img {
	...
	height: 140px;
	border-radius: 15px;
	background: linear-gradient(135deg, var(--c2), var(--c4)); /* ⚠️ CSS 변수 공백 오타 수정 */
}
...
.upload-box {
	height: 180px;
	border: 2px dashed var(--c3); /* ⚠️ CSS 변수 공백 오타 수정 */
	border-radius: 15px;
	display: flex;
...
<body>
	...
	<div class="container">
		...
		<form action="${pageContext.request.contextPath}/review/insert" method="POST" class="card">
